...
public class QuantitiesClassifier extends SparseNetworkLearner
{
  ...
  private static void loadInstance()
  {
    if (instance == null)
    {
      if (_lcFilePath == null)
      {
        throw new RuntimeException("Can't locate QuantitiesClassifier.lc in the class path.");
      }
  ...
  public QuantitiesClassifier(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }
  ...
  public QuantitiesClassifier(Parameters p, String modelPath, String lexiconPath) {
    ...
    if (modelfile.exists()) {
      ...
      readLexiconOnDemand(IOUtilities.loadFromClasspath(QuantitiesClassifier.class, lexiconPath));
    }
    else {
      containingPackage = "edu.illinois.cs.cogcomp.quant.lbj";
      name = "QuantitiesClassifier";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof Constituent || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'QuantitiesClassifier(Constituent)' defined on line 90 of chunk.lbj received '" + type + "' as input.");
  ...
  public int hashCode() { return "QuantitiesClassifier".hashCode(); }
  public boolean equals(Object o) { return o instanceof QuantitiesClassifier; }
